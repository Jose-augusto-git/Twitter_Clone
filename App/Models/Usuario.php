...
class Usuario extends Model{
    ...
    public function salvar(){
        ...
        $stmt->bindValue(':senha', $this->__get('senha'));//criptografia md5()-> hash 32 caracteres
        $stmt->execute();
    ...
    //Recuperar total de usuários que está seguindo
    ...
    //Recuperar total de usuários que está seguidores
